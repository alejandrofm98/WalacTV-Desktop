-- walactv: mp.get_script_directory() returns nil when loaded via dofile from wrapper.
-- Fall back to _G.UOSC_DIR (set by uosc.lua).
local script_dir = mp.get_script_directory() or _G.UOSC_DIR
local intl_dir = script_dir .. '/intl/'
local locale = {}
local cache = {}
